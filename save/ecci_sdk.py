...
class Client:
    ...
    def get_sub_data_payload_queue(self):
        # print(self._sub_data_payload_queue,"11111111")
    ...
    def _on_client_message(self, mqtt_client, userdata, msg):
        ...
        # print(rev_msg,"rev_msgrev_msgrev_msgrev_msg")
        try:
        ...
        if rev_msg['type'] == "cmd":
            ...
            # print(rev_msg['contents'],"rev_msgrev_msgrev_msgrev_msg11111111",sender)
        ...
        if sender in LISTEN_CONTAINERS:
            ...
            if all(list(LISTEN_CONTAINERS.values())):
                ...
                if ECCI_APP_CONTROLLER_CONTAINER:
                    ...
                    print("controller and component ready, app status change")
    ...
    def send_ready(self):
        ...
        if ECCI_APP_TYPE == "controller":
            ...
            # logger.debug("controller send ready")
            pass
        # 若为controller 应用容器，那么其就绪是通过brokermonitor发给系统
    ...
    def _on_client_publish(self, client, userdata, mid):
        logger.info("publish success")
    ...
    def initialize(self):
        ...
        try:
            ...
            self._mqtt_client.on_disconnect = self._on_client_disconnect
